        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex ml-auto gap-2 items-center">
                <a class="flex items-center" href="{{ route('post.create') }} ">
                    <x-primary-button class="h-10 flex items-center">
                        Create Post
                    </x-primary-button>
                </a>

                <!-- Show settings dropdown if authenticated -->
                @auth
                <!-- Settings Dropdown -->
                ...
                <!-- if not authenticated, show this -->
                @guest
                    <div class="flex items-center gap-2 px-3">
                        <a href="{{ route('login') }} ">
                        <x-secondary-button class="h-10 flex items-center">
                            Log In
                        </x-secondary-button>
                    </a>
